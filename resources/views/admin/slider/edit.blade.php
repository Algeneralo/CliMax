                ...
                <div class="form-group col-6">
                    ...
                    <div class="col-md-12">
                        <input id="first_text" type="text" class="form-control" name="first_text"
                               value="{{$slider->first_text}}">
                    </div>
                </div>
                <div class="form-group col-6">
                    <label class="ml-3">First Text Color</label>
                    <div class="input-group col-12 color-picker">
                        <input type="text" name="first_text_color" value="{{$slider->first_text_color}}"
                               class="form-control"/>
                ...
                <div class="form-group col-6">
                    ...
                    <div class="col-md-12">
                        <input id="second_text" type="text" class="form-control" name="second_text"
                               value="{{$slider->second_text}}">
                    </div>
                </div>
                <div class="form-group col-6">
                    <label class="ml-3">Second Text Color</label>
                    <div class="input-group col-12 color-picker">
                        <input type="text" name="second_text_color" value="{{$slider->second_text_color}}"
                               class="form-control"/>
                ...
                <div class="col-12">
                    <div class="avatar-upload rectangle">
                        ...
                        <div class="avatar-preview">
                            <div id="imagePreview"
                                 style="background-image: url({{asset('assets/images/upload/'.$slider->image)}})">>
                                <h1>{{$slider->first_text}}</h1>
