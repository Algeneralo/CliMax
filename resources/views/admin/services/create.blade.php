...
@endsection
@section('body')
    <form action="{{route('services.store')}}" method="post" class="m-b-30" enctype="multipart/form-data">
        @csrf
        <div class="card-box"><h4 class="header-title m-t-0 mb-3">Create Service</h4>
            <div class="row">
                ...
                <div class="form-group col-9">
                    ...
                    <textarea id="text_area" name="details">{{old("details")}}</textarea>
                </div>
                <div class="col-3">
